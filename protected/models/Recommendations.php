...
class Recommendations extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('users_id, serviceproviders_id', 'required'),
			array('users_id, serviceproviders_id', 'numerical', 'integerOnly'=>true),
			array('recommendation', 'length', 'max'=>512),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, recommendation, users_id, serviceproviders_id', 'safe', 'on'=>'search'),
		);
	}
