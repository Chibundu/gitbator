...
/**
 * This is the model class for table "{{proposalMessage}}".
 *
 * The followings are the available columns in table '{{proposalMessage}}':
 * @property integer $id
 ...
 */
class ProposalMessage extends CActiveRecord
{
	const READ = 0;
	const UNREAD = 1;	
	/**
	 * Returns the static model of the specified AR class.
	 * @return ProposalMessage the static model class
	 */
